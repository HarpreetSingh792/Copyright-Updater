    ...
    cpUpdater() {
        ...
        switch (this.format) {
            ...
            case Updater.formats.RANGED:
                return this.endYear ? `© ${this.startYear} - ${this.endYear}` : `© ${this.startYear} - ${currentYear}`;

            case Updater.formats.COPYRIGHT_RANGED:
                return this.endYear ? `Copyright ${this.startYear} - ${this.endYear}` : `Copyright ${this.startYear} - ${currentYear}`;
